...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_roll=(TextView) findViewById(R.id.rollno1);
        tv_name=(TextView) findViewById(R.id.name1);
        tv_phone=(TextView) findViewById(R.id.phone1);
        tv_email=(TextView) findViewById(R.id.email1);
        tv_password=(TextView) findViewById(R.id.password1);
        tv_gender=(TextView) findViewById(R.id.gender1);
        tv_branch=(TextView) findViewById(R.id.branch1);
